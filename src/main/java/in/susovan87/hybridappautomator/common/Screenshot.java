...
public class Screenshot
{
    ...
    private String generateHtml()
    {
        ...
        return String.format(imageHtmlFormat, getRelativePath(), getRelativePath(), getStyle(), getName());
    }
    ...
    private String generateFileName()
    {
        ...
        return String.format(nameFormat, testResult.getTestClass().getRealClass().getSimpleName(), getTestMethod());
    }
